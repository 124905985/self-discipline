 ...
 * under the License.
 */
package cn.suvue.discipline.practice.netty.push.handler;

import cn.suvue.discipline.practice.netty.push.test.TestCenter;
...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        if (!req.decoderResult().isSuccess() || req.method() != GET || (!"websocket".equals(req.headers().get(
                "Upgrade")))) {
